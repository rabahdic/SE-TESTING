  ...
  return (
    <main className="main">
      ...
      <p className="pt-4 pb-2">
        Here is a breakdown of your totals and budgets:
      </p>
      <div className="px-2 bg-slate-500 overflow-x-scroll">
        <CategoryBreakdown />
      </div>
      <p className="mx-10 pt-2">
        The higher the Difference percentage shown, the less likely are you to
        spend your money.
      </p>
    </main>
  )
...
const getTotals = (Items: Categories) => {
  ...
  for (const categories in Items) {
    total += parseFloat(Items[categories].Total) || 0
    totalBudget += parseFloat(Items[categories].Budget) || 0
  }
